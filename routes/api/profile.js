...
router.get('/me',auth,async (req,res)=>{
    ...
    try {
        ...
        if(!profile){
            return res.status(400).json("there is no profile for user");
        }
...
router.get('/github/:username',(req,res)=>{
    try {
        ...
        const options={
            uri:`https://api.github.com/users/${req.params.username}/repos?per_page=5&sort=created:asc&client_id=${config.get('githubClientId')}&client_id=${config.get('githubSecret')}`,
            method:'GET',
