...
export const createProfile=(formData,history,edit=false)=>async dispatch=>{
    try {
        ...
        dispatch(setAlert(edit ? 'Profile edited':'Profile Updated'));
        if(!edit){
    ...
    dispatch(setAlert('Error in making profile','danger'));
...
export const getProfileById=(user_id)=>async dispatch=>{
    ...
    try {
       ...
       dispatch(setAlert('Error in getting Profile','danger'));
